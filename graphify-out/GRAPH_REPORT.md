...
## Corpus Check
- 78 files · ~143,004 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 333 nodes · 525 edges · 34 communities (15 shown, 19 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ed1e2180`
...
- `WIF-16: Map Pin Style Loss on Language Change` --references--> `Map()`  [EXTRACTED]
  .sdd/specs/WIF-16.md → src/Map/Map.jsx
...
Cohesion: 0.10
Nodes (23): Countries(), SELECTED_STYLE, CustomMarker(), useImageRetry(), RETRY_DELAYS, useMapData(), useMapData Hook, BASE_STYLE (+15 more)

### Community 1 - "App Shell & Navigation"
Cohesion: 0.10
Nodes (24): ChannelPanel Component, IconComment(), IconEye(), IconThumbUp(), translations, AppearancesTooltip(), buildLastUpdatedLabel(), ChannelIdentity() (+16 more)
...
Cohesion: 0.16
Nodes (13): App(), ChannelPanel(), LanguageContext, CountryPanel(), Head(), JSON_LD, MANAGED_SELECTORS, WIF-11: Tooltip With Date Ranges For Channel History (+5 more)
...
Cohesion: 0.15
Nodes (14): App Component, Categories(), CATEGORY_RETRY_DELAYS, Categories Component, CountryPanelContext, MapPointContext, SidebarContext, Mutual Panel Exclusivity Pattern (+6 more)
...
Cohesion: 0.12
Nodes (16): LanguageProvider(), ThemeContext, ThemeProvider(), Theme & Language Persistence, Header(), MoonIcon(), SunIcon(), App Entry Point (+8 more)
...
## Knowledge Gaps
- **134 isolated node(s):** `Context / Background`, `Summary`, `A. Live clock label`, `B. Country modal — structure`, `C. Country modal — Tab 1 (real-time / today)` (+129 more)
...
- **Why does `App Component` connect `Runtime Dependencies` to `App Shell & Navigation`, `Point Rendering`, `Community 31`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `Feature Flags & Configuration` connect `Community 31` to `Runtime Dependencies`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `LanguageContext` connect `Country Panel` to `Map Rendering & Data`, `App Shell & Navigation`, `Point Rendering`, `Runtime Dependencies`?**
