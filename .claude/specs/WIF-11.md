...
- [x] Step 6 — **QA**: open the country panel in browser, verify tooltip appears on hover and keyboard focus, check EN/ES date formatting, confirm "+N more" count is correct, verify no layout shift. Check light and dark themes.
