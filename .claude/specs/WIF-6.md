...
- [ ] Step 6: Manual QA — verify all acceptance criteria: stat-based pin appearance, zoom-responsive sizing and flag visibility, distinct pin colors, no console errors.
