...
- [ ] Step 7: Manual QA — verify all acceptance criteria: stat-based pin appearance (opacity, border thickness, brightness), zoom-responsive sizing and flag visibility, distinct pin colors, no console errors.
