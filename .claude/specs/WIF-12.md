...
- [x] Step 5: Manual verification in the running dev container — confirm that previously broken channel images now load in map pins, InfoSidebar, and CountryPanel without waiting or refreshing.
