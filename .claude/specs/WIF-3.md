...
- [ ] Step 2: Create `_headers` file in the project root with the `Permissions-Policy: web-share=self` rule for all routes (`/*`), following the same pattern as `_redirects`.
